...
class InsightUIOptions extends NodeJsServiceOptions {
  ...
  mergeWithDefaultOptions(...customOptions) {
    ...
    const defaultContainerOptions = {
      image: 'Alterdot/insight',
      network: {
        name: 'alterdot_test_network',
        driver: 'bridge',
      },
      ports: [
        `${port}:${port}`,
  ...
  getConfigPath() {
    ...
    return path.join(tmpPath, 'bitcore-node-alterdot.json');
  }
